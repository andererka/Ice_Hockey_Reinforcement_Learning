...
n_latent_var2 = 64
update_timestep = 2000      # update policy every n timesteps (was set to 2000)
lr = 0.0001
betas = (0.9, 0.999)
...
if __name__ == '__main__':
    ...
    for episode in range(1, max_episodes+1):
        ...
        try:
            ...
            smoothed_rewards = running_mean(np.asarray(stats)[:, 1], 200).tolist()
        ...
        if ((episode > 0) and (episode % 200 == 0)):
            ...
            current_fig = subplot(current_fig, plot_reward, plot_smoothed_reward, plot_loss, plot_smoothed_losses, path = f'./figures/PPO_{env_name}-eps{eps_clip}-discount{gamma}-lr{lr}.jpg')
