...
ppo.policy_old.load_state_dict(torch.load('//home/kathi/Dokumente/ReIn_Course/project/laser-hockey-env-master/results/09-17_without closeness_to_puck&opponent_goal/PPO_HockeyEnv-eps02-discount099-lr0001-random_choice85.pth'))

ppo.policy.load_state_dict(torch.load('//home/kathi/Dokumente/ReIn_Course/project/laser-hockey-env-master/results/09-17_without closeness_to_puck&opponent_goal/PPO_HockeyEnv-eps02-discount099-lr0001-random_choice85.pth'))
    ...
    for episode in range(1, max_episodes + 1):
        ...
        try:
            ...
            if (smoothed_rewards[-1] >= best_smoothed_reward):
                ...
                torch.save(ppo.optimizer.state_dict(),
        ...
        if ((episode > 0) and (episode % 30 == 0)):
            ...
            current_fig = subplot(current_fig, plot_reward, plot_smoothed_reward, plot_loss, plot_smoothed_losses,
