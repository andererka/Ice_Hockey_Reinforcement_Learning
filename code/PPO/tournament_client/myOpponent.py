...
ppo.policy.load_state_dict(
    torch.load(
        "/home/kathi/Dokumente/ReIn_Course/project/laser-hockey-env-master/PPO/results/12-13:47:39/PPO_HockeyEnv-eps02-discount099-lr00001-action_std04.pth"
    )
)
...
if __name__ == "__main__":
    ...
    client = Client(
        username="Katharina_Anderer_Canucks",  # Testuser
