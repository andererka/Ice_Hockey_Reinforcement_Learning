...
class HockeyEnv(gym.Env, EzPickle):
    ...
    def _create_world(self):
        ...
        def _create_decoration():
            ...
            orange = (239.0 / 255, 203.0 / 255, 138.0 / 255)
    ...
    def _create_goal(self, position, poly):
        ...
        goal.color1 = (0.5, 0.5, 0.5)
        goal.color2 = (0.5, 0.5, 0.5)
    ...
    def reset(self, one_starting=None, mode=None):
        ...
        blue = (93.0 / 255, 158.0 / 255.0, 199.0 / 255.0)
        if self.mode != self.NORMAL:
    ...
    def _shoot(self, player):
        ...
        self.puck.ApplyForceToCenter(
            Box2D.b2Vec2(math.cos(player.angle), math.sin(player.angle))
            * self.puck.mass
            / self.timeStep
